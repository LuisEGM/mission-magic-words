...
export const LEVEL2_DATA: Level2Data = {
  id: 2,
  name: "2. El Puente de los Enigmas",
  ...
  challenges: [
    {
      ...
      feedback: {
        ...
        incorrect:
          "Piensa en una fruta que sea blanca en su interior y verde en su exterior.",
      },
    },
    {
      id: 2,
      ...
      feedback: {
        correct:
          "¡Correcto! Un reloj tiene agujas y números pero no cose ni hace matemáticas.",
        incorrect:
          "Piensa en algo que tenga agujas que se mueven y números alrededor.",
      },
    },
    {
      id: 3,
      ...
      options: [
        ...
        {
          id: "b",
          text: "Alguien que enfrenta sus miedos con coraje",
          correct: true,
        },
      ...
      feedback: {
        correct:
          "¡Perfecto! Ser valiente es enfrentar los miedos con coraje, no significa no tener miedo.",
        incorrect:
          "La valentía no es ausencia de miedo, sino tener el coraje para enfrentarlo.",
      },
    },
    {
      id: 4,
      ...
      feedback: {
        correct:
          "¡Excelente! Efímero significa algo que dura muy poco tiempo, como una flor que se marchita rápido.",
        incorrect:
          "Piensa en algo que existe por un momento muy breve, como un destello o una mariposa que vive poco.",
      },
    },
    {
      id: 5,
      ...
      feedback: {
        correct:
          "¡Correcto! La tristeza es una emoción natural cuando perdemos algo valioso.",
        incorrect:
          "Piensa en cómo te sentirías si perdieras algo muy especial para ti.",
      },
    },
    {
      id: 6,
      ...
      feedback: {
        correct:
          "¡Muy bien! El plátano tiene color dorado pero no es oro ni plata.",
        incorrect:
          "Piensa en una fruta de color amarillo dorado cuyo nombre está en la pista.",
      },
    },
    {
      id: 7,
      ...
      stars: 12,
      question:
        "¿Cuál es el sinónimo (palabra con significado similar) de 'feliz'?",
      options: [
      ...
      feedback: {
        correct:
          "¡Perfecto! Contento es un sinónimo de feliz, ambas palabras expresan alegría.",
        incorrect:
          "Busca una palabra que signifique lo mismo que feliz, que exprese alegría.",
      },
    },
    {
      id: 8,
      ...
      options: [
        ...
        {
          id: "b",
          text: "Satisfecho y contento con lo que ha logrado",
          correct: true,
        },
      ...
      feedback: {
        correct:
          "¡Excelente! Sentirse orgulloso es estar satisfecho y contento con nuestros logros.",
        incorrect:
          "Piensa en cómo te sientes cuando haces algo muy bien y todos te felicitan.",
      },
    },
  ],
};
