...
export const FinalScreen: React.FC = () => {
  ...
  const percentage = Math.round(
    (totalStars / GAME_CONFIG.totalPossibleStars) * 100
  );
      ...
      <div className="max-w-5xl mx-auto py-8">
              ...
              <div className="border-t-2 border-gray-200 pt-4">
                ...
                <div className="mt-2 text-center">
                  <span className="text-sm text-gray-600">
                    {percentage}% de {GAME_CONFIG.totalPossibleStars} estrellas
                    posibles
                  </span>
                </div>
              </div>
        ...
        >
          <Card className="p-8 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Has demostrado tus habilidades de comprensión, creatividad y
              valentía. Descarga tu diploma oficial como Guardián de las
              Historias.
            </p>
        ...
        >
          <p className="text-white text-lg">
            "Las palabras y las historias nos guían cuando sabemos escucharlas y
            comprenderlas."
          </p>
        </motion.div>
      </div>
