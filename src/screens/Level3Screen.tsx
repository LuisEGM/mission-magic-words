...
export const Level3Screen: React.FC = () => {
  ...
  const handleReview = () => {
    ...
    if (wordCount < LEVEL3_DATA.requirements.minWords) {
      alert(`Tu historia necesita al menos ${LEVEL3_DATA.requirements.minWords} palabras. Actualmente tiene ${wordCount}.`);
      return;
    }
    if (wordCount > LEVEL3_DATA.requirements.maxWords) {
      alert(`Tu historia no debe exceder ${LEVEL3_DATA.requirements.maxWords} palabras. Actualmente tiene ${wordCount}.`);
      return;
    }
    setStage('review');
  };
          ...
          <Card className="p-8 max-w-2xl">
            ...
            <div className="bg-purple-50 border-2 border-purple-200 rounded-lg p-4 mb-6">
              ...
              <ul className="list-disc list-inside space-y-1 text-gray-700">
                <li>Escribe una historia original de {LEVEL3_DATA.requirements.minWords}-{LEVEL3_DATA.requirements.maxWords} palabras</li>
                <li>Usa al menos {LEVEL3_DATA.requirements.minWordBankUsage} palabras del banco mágico</li>
                <li>Incluye al menos {LEVEL3_DATA.requirements.minDialogues} diálogo</li>
      ...
      <ScreenContainer>
        ...
        <div className="mt-8">
          ...
          <div className="text-center mt-6">
            <Button onClick={handleReview} size="lg" disabled={!title.trim() || !text.trim()}>
              Revisar Historia
            </Button>
          </div>
        </div>
          ...
          {passed ? (
            <>
              ...
              <p className="text-xl text-gray-600 mb-6">
                Has obtenido <span className="font-bold text-yellow-600">{level3Stars} estrellas</span>
              </p>
              <p className="text-gray-600">
                Tu creatividad ha sido excepcional. Preparándose para desbloquear la última palabra mágica...
              </p>
            </>
          ) : (
            <>
              ...
              <p className="text-xl text-gray-600 mb-6">
                Obtuviste <span className="font-bold text-yellow-600">{level3Stars} estrellas</span>
              </p>
              <p className="text-gray-600 mb-6">
                Necesitas al menos {LEVEL3_DATA.minStars} estrellas para continuar. Intenta mejorar tu historia.
              </p>
